...
public class Chat extends AppCompatActivity{
    ...
    TextView t1;
    String url = "ws://coms-309-069.cs.iastate.edu:8080/websocket/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // String w = "ws://coms-309-069.cs.iastate.edu:8080/websocket/cspainho" + e1.getText().toString();
                String w = url +idUser;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        Intent intent = new Intent(Chat.this,main_screen_activity.class);
